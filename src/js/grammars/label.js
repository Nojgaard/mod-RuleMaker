...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = function(lbl) { return lbl; },
      ...
      peg$c12 = function(charge) { return charge==="++"?2:-2; },
      peg$c13 = /^[0-9]/,
  ...
  function peg$parsestart() {
    ...
    s0 = peg$currPos;
    s1 = peg$parsemolecule();
    if (s1 === peg$FAILED) {
      s1 = peg$parsenonmolecule();
    }
    if (s1 !== peg$FAILED) {
      peg$savedPos = s0;
      s1 = peg$c0(s1);
